                    ...
                    {posts.map((post, index) => (
                        <div className="box cardColor p-2" key={index}>
                            ...
                            <div className='flex justify-between mt-2'>
                                <lord-icon src="https://cdn.lordicon.com/drxwpfop.json" onClick={() => { handleDelete(post.id) }} className="hover:cursor-pointer" trigger="hover" stroke="bold" state="hover-line" colors="primary:#ffffff,secondary:#ffffff" style={{ width: "30px", height: "30px" }} ></lord-icon>
